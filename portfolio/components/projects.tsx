                ...
                {project.image && (
                    <div className='h-72 w-full overflow-hidden bg-muted sm:h-60'>
                        <Image
                            src={project.image}
                            alt={project.title || ''}
                            // entweder fill oder height und width benutzen
                            // fill
                           height={300}
                            width={400}
            className='rounded-lg object-cover object-center transition-transform group-hover:scale-105 duration-300'
          />
          </div>
                )}

                <div className='absolute inset-[1px] rounded-lg bg-background/70' />
